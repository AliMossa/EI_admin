...
class EmployeePasswordTextFieldWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider<ShowPasswordCubit>(
      create: (context) => ShowPasswordCubit()..show(),
            ...
            children: [
              ...
              Container(
                ...
                child: TextFormField(
                  ...
                  obscureText: state is DoShowPasswordState ? false : true,
                  autovalidateMode: AutovalidateMode.onUserInteraction,
                  decoration: InputDecoration(
                    border: InputBorder.none,
                    suffixIcon: InkWell(
                      onTap: () => context.read<ShowPasswordCubit>().show(),
                      child:
                          state is DoShowPasswordState
