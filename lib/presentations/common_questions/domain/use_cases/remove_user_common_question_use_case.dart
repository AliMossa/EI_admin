...
class RemoveUserCommonQuestionUseCase {
  CommonQuestionsRepository commonQuestionsRepository;
  RemoveUserCommonQuestionUseCase({required this.commonQuestionsRepository});
  Future<Either<AdminExceptions, String>> call(
    RemoveCommonQuestionEntity removeCommonQuestions,
  ) async {
    return await commonQuestionsRepository.removeUserQuestion(
