import 'package:admin_dashboard/presentations/monitoring_history/data/data_source/get_logs_data_source.dart';
...
import 'package:admin_dashboard/presentations/monitoring_history/domain/repositories/monitoring_history_repository.dart';
...
class LogsRepositoryImpSource implements MonitoringHistoryRepository {
  ...
  Future<Either<AdminExceptions, TotalLogsEntity>> getLogs(
    ...
    try {
      return right(await GetLogsDataSourceWithDio().getLogs(logsRequest));
